...
class DeepInfoMaxLoss(nn.Module):
    def __init__(self, z_dim, alpha=0.5, beta=1.0, gamma=0.1):
        super().__init__()
        self.global_d = GlobalDiscriminator(z_dim)
        self.local_d = LocalDiscriminator(z_dim)
        self.prior_d = PriorDiscriminator(z_dim)
        self.alpha = alpha
        self.beta = beta
        self.gamma = gamma
...
class Encoder(nn.Module):
    def __init__(self, z_dim, return_features=True):
        super().__init__()
