...
class WideResNet(torch.nn.Module):
    def __init__(self, depth, width, num_classes, dropout=0.1):
        ...
        torch.nn.init.kaiming_normal_(self.conv0.weight.data)
        self.group_0 = Group(16, widths[0], self.n, 1, dropout=dropout)
        self.group_1 = Group(widths[0], widths[1], self.n, 2, dropout=dropout)
        self.group_2 = Group(widths[1], widths[2], self.n, 2, dropout=dropout)
